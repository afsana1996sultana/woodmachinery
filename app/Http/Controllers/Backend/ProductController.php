...
class ProductController extends Controller
{
    ...
    {
        $products =null;
        $vproducts = ProductStock::where('id',$id)->first();
        $product = Product::where('id',$vproducts->product_id)->first();
        $staffs = Staff::latest()->get();
        return view('backend.product.menufacturingprint',compact('vproducts','product','products','staffs'));
    }
