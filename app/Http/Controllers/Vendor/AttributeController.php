...
class AttributeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.template.attribute.index', compact('attributes'));
    }
    ...
    {
        return view('vendor.template.attribute.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $attribute->created_by = Auth::guard('vendor')->user()->id;
    ...
    public function show($id)
    {
        ...
        return view('vendor.template.attribute.show',compact('attribute', 'values'));
    }
    ...
    {
        $attribute = Attribute::findOrFail($id);
        return view('vendor.template.attribute.edit',compact('attribute'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.attribute.index')->with($notification);
    }
    ...
    public function value_store(Request $request)
    {
        ...
        $value->created_by = Auth::guard('vendor')->user()->id;
    ...
    public function value_edit($id)
    {
        ...
        return view('vendor.template.attribute.value_edit',compact('attr_val'));
    }
    ...
    public function value_update(Request $request, $id)
    {
        ...
        $attribute_val->created_by = Auth::guard('vendor')->user()->id;
    ...
    public function index_unit()
    {
        ...
        return view('vendor.template.unit.index', compact('units'));
    }
    public function create_unit()
    {
        return view('vendor.template.unit.create');
    }
    public function store_unit(Request $request)
    {
        ...
        $unit->created_by = Auth::guard('vendor')->user()->id;
        $unit->created_at = Carbon::now();
        $unit->save();

        Session::flash('success','Unit Inserted Successfully');
        return redirect()->route('vendor.unit.index');
    }
    public function edit_unit($id)
    {
        $unit = Unit::findOrFail($id);
        return view('vendor.template.unit.edit',compact('unit'));
    }
    public function update_unit(Request $request, $id)
    {
        ...
        return redirect()->route('vendor.unit.index')->with($notification);
    }
