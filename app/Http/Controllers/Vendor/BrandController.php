...
class BrandController extends Controller
{
    ...
    public function BrandView(){
    	...
    	return view('vendor.template.brand.brand_view',compact('brands'));
    }

    /*=================== Start BrandAdd Methoed ===================*/
    public function BrandAdd(){
        return view('vendor.template.brand.brand_add');
    ...
    public function BrandStore(Request $request){
		...
		return redirect()->route('vendor.brand.all');
    ...
    public function BrandEdit($id){
    	...
    	return view('vendor.template.brand.brand_edit',compact('brand'));
    }
    ...
    public function BrandUpdate(Request $request, $id){
        ...
        return redirect()->route('vendor.brand.all')->with($notification);
    } // end method
