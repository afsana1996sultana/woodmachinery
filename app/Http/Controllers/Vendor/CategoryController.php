...
class CategoryController extends Controller
{
    ...
    public function index(){
        ...
        return view('vendor.template.category.index',compact('categories'));
    } // end method
    ...
    public function create(){
        ...
        return view('vendor.template.category.create',compact('categories'));
    } // end method
    ...
    public function edit($id)
    {
        ...
        return view('vendor.template.category.edit',compact('category', 'categories'));
    } // end method
    ...
    public function CategoryUpdate(Request $request, $id){
		...
		return redirect()->route('vendor.category.all');
    }
