...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('vendor.template.sales.all_orders.index', compact('orders', 'delivery_status', 'date','payment_status'));
    }
    ...
    public function show($id)
    {
        ...
        return view('vendor.template.sales.all_orders.show', compact('order', 'shippings'));
    }
    ...
    public function invoice_download($id){
        ...
        $pdf = PDF::loadView('vendor.template.invoices.invoice',compact('order'))->setPaper('a4');
        return $pdf->download('invoice.pdf');
    } // end method
    /* ============= End invoice_download Method ============== */
     public function invoice_print_download($id){
        ...
        // dd($pdf);
        return view('vendor.template.invoices.invoice_print', compact('order'));
