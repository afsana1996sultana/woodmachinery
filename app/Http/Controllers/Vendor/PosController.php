...
class PosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('vendor.template.pos.index', compact('products', 'categories', 'brands', 'customers','staffs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('vendor.print.invoice.download', compact('order'))->with($notification);
    }
