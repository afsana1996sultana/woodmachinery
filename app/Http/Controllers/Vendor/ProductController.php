...
class ProductController extends Controller
{
    ...
    public function ProductView(){
        $products = Product::where('vendor_id', Auth::guard('vendor')->user()->id)->latest()->get();
        return view('vendor.template.product.product_view',compact('products'));
    } // end method
    ...
    public function ProductAdd(){
    	...
    	return view('vendor.template.product.product_add',compact('categories','brands','vendors','suppliers','attributes','units'));
    ...
    public function EditProduct($id){
        ...
        return view('vendor.template.product.product_edit',compact('categories','vendors','suppliers','brands','attributes','product','multiImgs','units'));
    ...
    public function categoryInsert(Request $request)
    {
        ...
        $category->created_by = Auth::guard('vendor')->user()->id;
        $category->save();
    ...
    public function brandInsert(Request $request)
    {
        ...
        $brand->created_by = Auth::guard('vendor')->user()->id;
