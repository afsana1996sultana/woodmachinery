...
<html lang="en">
    <head>
        ...
        <!-- summernote -->
        <link href="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <!-- Main Script -->
        <script src="{{ asset('backend/assets/js/main.js?v=1.1 ') }}"></script>
