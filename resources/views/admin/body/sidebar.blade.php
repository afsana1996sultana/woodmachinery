...
<aside class="navbar-aside bg-primary" id="offcanvas_aside">
    ...
    <nav>
        <ul class="menu-aside">
            ...
            <li class="menu-item has-submenu 
                {{ ($prefix == 'admin/product') || ($prefix == 'admin/category')|| ($prefix == 'admin/unit') || ($route == 'attribute.index') || ($prefix == 'admin/brand') || ($route == 'menufacturing.index') ? 'active' : '' }}
            ">
            ...
            @if(Auth::guard('admin')->user()->role == '1')
                ...
                ">
                    ...
                    <div class="submenu">
                        <a class="{{ ($route == 'dealer.index') ? 'active':'' }}" href="{{ route('dealer.index') }}">Dealers List</a>
                        <a class="{{ ($route == 'dealer.create') ? 'active':'' }}" href="{{ route('dealer.create') }}">Dealer Add</a>
