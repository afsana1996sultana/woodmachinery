					...
					<form method="post" action="{{ route('dealer.store') }}" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-6 mb-4">
								...
								<input class="form-control" id="name" type="text" name="name" placeholder="Write Dealer name" value="{{old('name')}}">
								@error('name')
							...
							<label for="phone" class="col-form-label col-md-4" style="font-weight: bold;"> Phone : <span class="text-danger">*</span></label>
								<input class="form-control" id="phone" type="text" name="phone" placeholder="Write Dealer phone number" value="{{old('phone')}}">
								@error('phone')
									<p class="text-danger">{{$message}}</p>
								@enderror
							</div>
							...
							<label for="email" class="col-form-label col-md-4" style="font-weight: bold;"> Email : <span class="text-danger">*</span></label>
								<input class="form-control" id="email" type="email" name="email" placeholder="Write Dealer email address" value="{{old('email')}}">
								@error('email')
									<p class="text-danger">{{$message}}</p>
								@enderror
							</div>
							...
							<div class="col-md-6 mb-4">
								...
								<input class="form-control" id="address" type="text" name="address" placeholder="Write Dealer address" value="{{old('address')}}">
								@error('address')
									<p class="text-danger">{{$message}}</p>
								@enderror
							</div>
							...
							<div class="col-md-6 mb-4">
								...
								<textarea name="description" id="description" cols="5" placeholder="Write Dealer description" class="form-control ">{{old('description')}}</textarea>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
							...
							<div class="col-md-6">
								...
								<div class="mb-4">
									<label for="image2" class="col-form-label" style="font-weight: bold;">Bank Information:</label>
