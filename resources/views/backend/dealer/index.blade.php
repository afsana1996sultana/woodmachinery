                ...
                <table id="example" class="table table-bordered table-striped" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($dealer->status == 1)
                                  <a @if($dealer->user->is_approved != 0) href="{{ route('dealer.in_active',['id'=>$dealer->id]) }}" @endif>
                                    <span class="badge rounded-pill alert-success">Active</span>
                                  </a>
                                @else
                                  <a  href="{{ route('dealer.active',['id'=>$dealer->id]) }}" > <span class="badge rounded-pill alert-danger">Disable</span></a>
                                @endif
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                ...
                                <a class="btn btn-md rounded font-sm" href="{{ route('dealer.edit',$dealer->id) }}">Edit info</a>
