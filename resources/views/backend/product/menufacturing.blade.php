                            ...
                            @if($product->is_varient)
                                @foreach ($product->stocks as $key => $stock)
                                    <tr>
                                        ...
                                        <td>
                                            <form>
                                                <label class="radio-inline"><input type="radio" name="optradio" id="Body_Parts" onclick="selectType('Body-Parts',{{$stock->id}})">&nbsp; Body Parts</label>&nbsp;
                                                  
                                                <label class="radio-inline"><input type="radio" name="optradio" id="Finishing_Parts" onclick="selectType('Finishing-Parts',{{$stock->id}})">&nbsp; Finishing Parts</label>
                                            </form>
                                        </td>
                                        <td>
                                            <select name="staff_id" class="form-control select-active w-100 form-select" id="staff_id{{$stock->id}}" onchange="sendStaff({{$stock->id}})">
