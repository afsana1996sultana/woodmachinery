	    ...
	    <div style="padding: 0px 20px;">
            ...
            @if($vproducts  != null)
                <table style="padding: 20px 0px;">
                    <tr>
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;"> Name: </span> {{ $vproducts->product->name_en }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;"> Variant:</span> {{ $vproducts->varient }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;"> Manufacturing Quantity:</span> {{ $vproducts->manu_qty }}</td>
                    </tr>
                    <tr>
                        <td style="text-align: center"><span style="font-weight: 800; margin-left:5px;"> Assaign By:</span> {{ $vproducts->user->name ?? '' }}</td>
                    </tr>
                </table>
                <img src="{{ asset($vproducts->manufimage) }}" class="img-sm" alt="Userpic" style="display: flex;margin-left: auto;margin-right: auto;">
            @endif
		</div>
