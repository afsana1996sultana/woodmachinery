		        		...
		        		<div class="row">
	                        ...
	                        <div class="col-md-6 mb-4">
				                <div class="custom_select cit-multi-select">
                                    ...
                                    <select class="form-control select-active w-100 form-select select-nice" name="choice_attributes[]" id="choice_attributes" onchange="selectAttribute()" multiple="multiple" data-placeholder="Choose Attributes">
		        ...
		        <div class="card">
		        	...
		        	<div class="card-body">
		        		<div class="row">
							...
							<div class="col-12 mt-2 mb-2" id="variation_wrapper" style="display: block; padding-left: 0px !important; padding-right: 0px !important;">
                        ...
                        <div class="mb-4">
							<div class="row">
                          		<div class="custom-control custom-switch mb-2">
                                    <input type="checkbox" class="form-check-input me-2 cursor" name="is_dealer" id="is_dealer" value="1">
				...
				// 	let finishingrate = $('#finishing_rate').val();
					...
					$('#combination_table tbody').html($.map(response.data, function (item, index) {
						return `<tr>
									...
									<td><input type="text" name="vpurchesprices[]" class="form-control vdpurvhedp" value="`+purchase_price+`" required></td>
									...
									<td><input type="text" name="vwholesaleprices[]" class="form-control vwholesaleprices" value="`+whole_sell_price+`" required></td>
									<td><input type="text" name="vwholesaleqtys[]" class="form-control vwholesaleqtys" value="`+whole_sell_qty+`" required></td>
...
<script type="text/javascript">
    ...
    // $('#body_rate').on('keyup', function() {
    // 	var bodyrate = $('#body_rate').val();
    // 	$('.vbodyrates').val(bodyrate);
    // });
    
    // $('#finishing_rate').on('keyup', function() {
    // 	var finishingrate = $('#finishing_rate').val();
    // 	$('.vfinishingrates').val(finishingrate);
    // });
