                        ...
                        <table id="example" class="table table-bordered table-striped table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
			                            <a  class="btn btn-primary btn-icon btn-circle btn-sm btn-xs" href="{{route('admin.all_request.show',$all_request->id) }}">
			                                <i class="fa-solid fa-eye"></i>
			                            </a>
			                            {{-- <a class="btn btn-primary btn-icon btn-circle btn-sm btn-xs" href="{{ route('invoice.download', $order->id) }}">
			                                <i class="fa-solid fa-download"></i>
			                            </a> --}}
			                            <a href="{{ route('admin.delete.request',$all_request->id) }}" id="delete" class="btn bg-danger btn-icon btn-circle btn-sm btn-xs" data-href="#" >
