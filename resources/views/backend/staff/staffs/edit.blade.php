...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{route('staff.index') }}" class="btn btn-primary"><i class="material-icons md-plus"></i> Staff List</a>
        </div>
    </div>
		                    ...
		                    <form action="{{ route('staff.update', $staff->id) }}" method="POST" enctype="multipart/form-data">
		                        ...
		                        <div class="custom_select mb-4">
                                 ...
                                 <div class="custom_select">
		                        	<label for="supplier_id" class="col-form-label" style="font-weight: bold;">Type:</label>
                                    <select class="form-control select-active w-100 form-select select-nice" name="type">
                                        <option value="Body-Parts" {{ $staff->type == 'Body-Parts' ? 'selected': '' }}>Body Parts</option>
                                        <option value="Finishing-Parts" {{ $staff->type == 'Finishing-Parts' ? 'selected': '' }}>Finishing Parts</option>
                                    </select>
                                </div>
