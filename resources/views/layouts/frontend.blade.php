            ...
            dataType:'json',
                success:function(data){
                    ...
                    if(data && data != 'na'){
                        ...
                        $('.mz-lens img').attr("src", window.location.origin+'/'+data.image);
                        $('#zoom-fig a').attr("href", window.location.origin+'/'+data.image);
                        $('#zoom-fig a').attr("data-zoom-image-2x", window.location.origin+'/'+data.image);
                        $('#zoom-fig a').attr("data-image-2x", window.location.origin+'/'+data.image);
                        $('#zoom-fig a').attr("data-image-2x", window.location.origin+'/'+data.image);
                        $('#zoom-fig span img').attr("src", window.location.origin+'/'+data.image);
                    }
                }
            });
        }
