    ...
    <div class="row">
        <div class="col-md-12 col-9">
            <div class="content-header">
                ...
                <div>
                    <a href="{{ route('vendor.attribute.index') }}" class="btn btn-primary"><i class="fa-solid fa-arrow-left mt-0"></i> Attribute List</a>
                </div>
            </div>
        </div>
        <div class="col-lg-7">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    {{-- <form method="post" action="{{ route('vendor.attribute.update',$attribute->id) }}" enctype="multipart/form-data"> --}}
        ...
        {{-- <div class="col-lg-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('vendor.attribute.value_store') }}" enctype="multipart/form-data">
                        @csrf
