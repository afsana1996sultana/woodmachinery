...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{ route('vendor.category.index') }}" class="btn btn-primary"><i class="material-icons md-plus"></i>Back To List</a>
        </div>
    </div> 
        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                           <form class="form-horizontal" action="{{ route('vendor.categories.store') }}" method="POST" enctype="multipart/form-data">
			                	@csrf
