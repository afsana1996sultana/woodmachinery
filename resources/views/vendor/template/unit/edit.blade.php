...
<section class="content-main">
    <div class="content-header">
        ...
        <div class="">
            <a href="{{ route('vendor.unit.index') }}" class="btn btn-primary"><i class="fa-solid fa-arrow-left mt-0"></i> Unit List</a>
        </div>
    </div> 
    	...
    	<div class="col-sm-6">
    		<div class="card">
		        <div class="card-body">
		            <div class="row">
		                <div class="col-md-12">
		                    <form method="post" action="{{ route('vendor.unit.update',$unit->id) }}" enctype="multipart/form-data">
		                    	@csrf
		                        <div class="mb-4">
