            ...
            <section class="content-main">
                <div class="card mx-auto card-login shadow-lg" style="margin-top: 70px;">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-4 text-center">Vendor Login</h4>
                        ...
                        @csrf
                            ...
                            <!-- form-group// -->
                            <div class="mb-3">
                                <a href="{{ route('vendor.password.request') }}" class="float-end font-sm text-muted">Forgot password?</a>
                        ...
                        <p class="text-center mb-4">Don't have account? <a href="{{ route('vendor.regester') }}">Sign up</a></p>
                    </div>
                </div>
            </section>
        </main>
