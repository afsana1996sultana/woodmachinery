               ...
               @include('vendor.body.asidebar')
                <div class="col-lg-9">
                    <section class="content-body p-xl-4">
                        <form method="post" action="{{ route('vendor.store.profile') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="row gx-3">
                                ...
                                <aside class="col-lg-4">
                                    <figure class="text-lg-center">
                                        <img id="showImage" class="img-lg mb-3 img-avatar" src="{{ (!empty($vendorData->profile_image))? url('upload/vendor_images/'.$vendorData->profile_image):url('upload/no_image.jpg') }}" alt="User Photo" />
