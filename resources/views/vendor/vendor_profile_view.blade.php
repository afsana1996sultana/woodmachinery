							...
							<div class="col-12 col-lg-12">
							   <div class="box box-widget widget-user">
							      ...
							      <div class="widget-user-image" style="    position: absolute; top: 128px; left: 50%;margin-left: 58px;">
							        <img class="" style="width: 100px; height: 100px; border-radius: 50%;" src="{{ (!empty($vendorData->profile_image))? url('upload/vendor_images/'.$vendorData->profile_image):url('upload/no_image.jpg') }}" alt="User Avatar">
							      </div>
							      <div class="box-footer">
							        <div class="row mt-3">
							        	<div class="col-12">
							               <div class="">
								               	<p>Name : <span class="text-gray ps-10">{{ $vendorData->name ?? 'NULL' }}</span> </p>
								                <p>Email : <span class="text-gray ps-10">{{ $vendorData->email ?? 'NULL' }}</span> </p>
								                <p>Phone : <span class="text-gray ps-10">{{ $vendorData->phone ?? 'NULL' }}</span></p>
								                <p>Address : <span class="text-gray ps-10">{{ $vendorData->address ?? 'NULL' }}</span></p>
							               </div>
							           </div>
