...
// Dealer Apply
Route::post('/dealer-apply', [FrontendController::class, 'dealerApply'])->name('dealerApply');
Route::post('/vendor-apply', [FrontendController::class, 'vendorApply'])->name('vendorApply');
